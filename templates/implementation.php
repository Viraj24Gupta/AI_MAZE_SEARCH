    ...
    <div id="page-content-wrapper">
        ...
        <?php
            if($visible){
                echo '
                <div class="form" style="display: flex">
                            <h4><label for="mazeop" >The combination of steps to reach the final position is:<span style="color:red;">'.$comboE.'</span></label></h4>
                            <!-- <textarea class="form-control" id="mazeop" name="output_matrix" -->
                                    <!-- style="background-color: azure; margin-bottom: 10px;margin-left: 10px" placeholder=""></textarea> -->
                        </div>
                        <div class="form" style="display: flex">
                            <h4><label for="searchop" >The number of steps to reach the final position is:<span style="color:red;">'.$numstepsE.'</span></label></h4>
                            <!-- <textarea class="form-control" id="searchop" name="search" -->
                                    <!-- style="background-color: azure; margin-bottom: 10px;margin-left: 10px" placeholder=""></textarea> -->
                        </div>
                        <div class="form" style="display: flex">
                            <h4><label for="timeop" >The time required to find the path to reach the final position is:<span style="color:red;">'.$timeE.'</span></label></h4>
                            <!-- <textarea class="form-control" id="timeop" name="time" -->
                                    <!-- style="background-color: azure; margin-bottom: 10px;margin-left: 10px" placeholder=""></textarea> -->
                        </div>
                        <div class="form" style="display: flex">
                            <h4><label for="travop" >The total number of steps in the traversal:<span style="color:red;">'.$totalE.'</span></label></h4>
                            <!-- <textarea class="form-control" id="travop" name="time" -->
                                    <!-- style="background-color: azure; margin-bottom: 10px;margin-left: 10px" placeholder=""></textarea> -->
                        </div>
                    </div>
                </div>
